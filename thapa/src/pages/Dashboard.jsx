                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-primary/5 dark:bg-primary/10 rounded-2xl p-6 border border-primary/20 flex flex-col justify-between">
                                    ...
                                    <button
                                        ...
                                        className="mt-6 w-full !bg-red-500 hover:!bg-red-600 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-red-500/20"
                                    >
                                        View Details
                                    </button>
                                </div>
                            ...
                            <section className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
                                ...
                                <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                                    <button 
                                        ...
                                        className="w-full flex items-center justify-center gap-2 bg-slate-50 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 py-2.5 rounded-xl text-xs font-bold transition-colors disabled:opacity-50"
                                    >
                                        <span className="material-symbols-outlined text-[16px]">{isSendingEmail ? 'hourglass_empty' : 'mark_email_read'}</span>
                                        {isSendingEmail ? 'Sending...' : 'Test AI Email Reminder'}
                                    </button>
                                </div>
                            </section>
                            <section className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-200 dark:border-slate-800">
